...
// Таймер подсчёта
const int count_timer_ms      = 250;         // Интервал накопления подсчёта (мс)
...
// TODO - Контроль открытого входа тестера
// Пин A0 длджен быть соединен с D2
...
void loop() {
    ...
    if (btn2.click()) { 
      ...
      Serial.print("periods_on_screen=");
